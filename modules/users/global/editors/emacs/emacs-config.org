...
#+begin_src emacs-lisp
  ...
  ;; Tbs is a comment with a spelling mistake
...
#+begin_src emacs-lisp
  (use-package
   ...
   (setopt eglot-events-buffer-config (plist-put eglot-events-buffer-config :size 0)))
#+end_src
** COMMENT Flycheck
#+begin_src emacs-lisp
  (use-package flycheck
    :config
    (setopt flycheck--idle-trigger-timer 5)
    (setopt flycheck-idle-change-delay 5)
    :init
...
#+begin_src emacs-lisp
  ...
  (use-package
   elisp-mode
   :config
   (defun 4lc/disable-flycheck-emacs-lisp-checkdoc ()
     (setq-local flycheck-disabled-checkers '(emacs-lisp-checkdoc)))

   :hook
   ;; (org-src-mode . 4lc/disable-flycheck-emacs-lisp-checkdoc)
   (emacs-lisp-mode
    .
    (lambda ()
...
#+begin_src emacs-lisp
  ...
  (advice-add 'flymake-diag-region :around #'flymake-diag-region-drop-col)
