...
#+begin_src emacs-lisp :tangle yes
  ...
  (defun cloveynit-text-face ()
    (setopt buffer-face-mode-face '(:family "Iosevka"))
    (buffer-face-mode))

  (defun cloveynit-org-face ()
    (set-face-attribute 'org-default nil :family "Iosevka"))
  ...
  (add-hook 'text-mode-hook #'cloveynit-text-face)
  (add-hook 'org-mode-hook #'cloveynit-org-face)
#+end_src
** Consult
#+begin_src emacs-lisp :tangle yes
  (use-package consult
