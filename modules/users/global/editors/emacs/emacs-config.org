  ...
  (use-package
   ...
   (setq display-buffer-base-action
         '((display-buffer--maybe-same-window
            display-buffer-reuse-window display-buffer-maybe-most-recent-window)))
   ;; (setq display-buffer-base-action
...
#+begin_src emacs-lisp
  (use-package highlight-indent-guides
    :config
    (setopt highlight-indent-guides-responsive 'top)
...
#+begin_src emacs-lisp
  (use-package simple
    :init
    (setopt display-line-numbesr-type 'relative)
    :hook
    (prog-mode . column-number-mode)
    (yaml-mode . column-number-mode)
