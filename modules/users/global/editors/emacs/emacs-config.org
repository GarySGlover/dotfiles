...
#+begin_src emacs-lisp :tangle yes
  (use-package
   ...
   (setq magit-dispnlay-buffer-function #'display-buffer)
   (advice-add
  ...
  (use-package
   ...
   (defmacro format-all-update-formatter (langid formatter)
    `(setq-default format-all-formatters
           (cons
            '(,langid ,formatter)
            (assq-delete-all ,langid format-all-formatters))))
...
#+begin_src emacs-lisp :tangle yes
  (use-package
   ...
   (:map
    ...
    ("C-<backspace>" . sp-backward-delete-char)
    ("C-M-(" . sp-wrap-round)
    ("C-M-[" . sp-wrap-square)
    ("C-M-{" . sp-wrap-curly)
...
#+begin_src emacs-lisp :tangle yes
  (use-package
   ...
   (bash-ts-mode
    .
    (lambda ()
      (format-all-update-formatter "Shell" (shfmt "-i" "2" "-ci")))))
#+end_src
** CMake
#+begin_src emacs-lisp :tangle yes
