...
#+begin_src emacs-lisp :tangle yes
  (defun cloveynit-after-frame ()
    ...
    (set-face-attribute 'variable-pitch nil :family "FiraCode Nerd Font" :height 98))

  (defun cloveynit-text-mode-default-face ()
    (face-remap-add-relative 'default :family "EB Garamond" :height 120))
  (add-hook 'text-mode-hook #'cloveynit-text-mode-default-face)
