      ...
      homeManager = {
        ...
        editor.initFiles.project.text = ''
          ...
          REPO should be formatted as 'user/repo'."
            ...
            ;; (push '(:platform azure :name "Next-Technology/Ecom.Infrastructure/Ecom.Account" :location home :type code) my-git-repo-database)
            ;; (my-git-repo-database-save-db my-git-repo-database-store)
